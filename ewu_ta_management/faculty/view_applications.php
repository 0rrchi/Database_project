...
$stmt = $conn->prepare("
    ...
    /*
        Do not show applications from students
        who have already been accepted by another
        faculty.

        The current faculty's own Accepted application
        is still allowed to appear.
    */
